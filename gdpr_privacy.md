...
This website uses Google Analytics for basic traffic analysis, which utilises browser cookies. It is configured to anonymise the IP addresses of visitors to the site, so that no personally identifiable information is collected by Google or by anyone else.